...
public class VerPaquetes extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerPaquetes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerPaquetes().setVisible(true);
            }
        });
    }
    ...
    public void llenarDatos() {
        ...
        txtDatos.setText(estructuras.devuelveListaPaquetesCompleta().toString());
    }
